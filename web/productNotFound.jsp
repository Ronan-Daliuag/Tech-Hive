<%-- 
    ...
    Created on : 05 11, 23, 11:38:09 PM
    Author     : Benjo
--%>
    ...
    <body>
        ...
        <div class="small-container 404page" align="center">
            <section class="center">
                <img class="loginError" src="styles/errorImages/productNotFound.png" alt="404.png" height="380" width="720" align="center"/>
                <h2>The product that you're looking for does not exist.</h2>
